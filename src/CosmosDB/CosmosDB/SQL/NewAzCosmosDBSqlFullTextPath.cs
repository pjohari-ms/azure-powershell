...
{
    [Cmdlet(VerbsCommon.New, ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "CosmosDBSqlFullTextPath"), OutputType(typeof(PSFullTextPath))]
    public class NewAzCosmosDBSqlFullTextPath : AzureCosmosDBCmdletBase
    {
        [Parameter(Mandatory = true, HelpMessage = Constants.FullTextPathHelpMessage)]
        ...
        {
            WriteObject(new PSFullTextPath
            {
                Path = Path,
                Language = Language,
                Tokenizer = Tokenizer,
