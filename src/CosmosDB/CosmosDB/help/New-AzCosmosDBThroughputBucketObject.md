...
### Example 1
```powershell
New-AzCosmosDBThroughputBucketObject -Id 1 -MaxThroughputPercentage 10 -IsDefaultBucket $true
```

Creates the default throughput bucket with Id 1 and maximum throughput percentage of 10.

### Example 2
```powershell
New-AzCosmosDBThroughputBucketObject -Id 2 -MaxThroughputPercentage 20 -IsDefaultBucket $false
```

Creates a throughput bucket with Id 2 and maximum throughput percentage of 20, explicitly marked as not default.

### Example 3
```powershell
New-AzCosmosDBThroughputBucketObject -Id 3 -MaxThroughputPercentage 15
```

Creates a throughput bucket with Id 3 and maximum throughput percentage of 15 without setting the optional default flag.
